...
import { AuthMethodTable, SessionTable, UserTable, type User } from '../db/schema'
...
import type { AuthProviderName } from './providers'
...
export const signInWithEmail = async (
  ...
  // Get the user data
  const user = await getUserById(ctx, authMethod.userId);
  if (!user) {
